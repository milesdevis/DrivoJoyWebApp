  ...
  var methods = {
    ...
    init: function(options) {
      ...
      function initElement($select) {
        ...
        // Create the UL that will be used as dropdown and cache it AS $ul, Hard coding the height of dropdowns dynamically - need to change it
        var $ul = $("<ul style='max-height:300px;'></ul>");
        $ul.data("select", $select);

          // Set height of the dropdown of dynamically
        //var coordsOnLoad = {
